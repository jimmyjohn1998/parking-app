...
<html lang="en">
<head>
<title>SMART PARKING| Index</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta charset="utf-8">
<meta name="keywords" content="SMART PARKING" />
...
<body>
			...
			<div class="container">
				...
				<nav class="navbar navbar-inverse">
					<div class="navbar-header">
					  ...
					  <a class="navbar-brand" href="index.html"><h1>SMART PARKING</h1></a>
			...
			<div class="w3-services-grids">
				<div class="col-md-4 w3services-left">
					<div class="w3-services-info">
						...
						<h3>LOOK </h3>
						<p>Find convinent parking spot near your destination.</p>
					</div>
					<div class="w3-services-info">
						<i class="fa fa-cogs  w3_icon " aria-hidden="true"></i>
						<h3>BOOK</h3>
						<p>Pre pay your spot and get a parking slot instentely via text or the app and can have a guaranteed space waiting .</p>
					</div>
				</div>
				...
				<div class="col-md-4 w3services-right">
					<div class="w3-services-info">
						...
						<h3>PARK </h3>
						<p>Scan or show your mobile parking code when you arrive, and you are all set. SAVE TIME AND MONEY.</p>
					</div>
					<div class="w3-services-info">
						<i class="fa fa-tasks  w3_icon " aria-hidden="true"></i>
						<h3> STRESS FREE JOUNERYS </h3>
						<p>View real time availability information for all parking options.Reserve guaranteed space for maximum peace of mind.</p>
					</div>
				</div>
		...
		<div class="container">
			...
			<div class="w3ls_banner_bottom_grids">
				<div class="col-md-6 w3_agileits_about_grid_left">
					<p>SMART PARKING-Pick Pay Park is an advanced and efficient parking application it provides services for prebooking, cancellation. It provide option for convinent parking slot near your destination. we can prebook slot so that you can guarantee your slot if we want to cancel slot this application provide a cancellation service so we can save our money.One of the main service is we providing a feedback option so users can give their view in the form of feedback so we can identify the services of each parking owner. Security and satisfaction is our main objectives.</i>
					</p>
					<ul>
			...
			<div class="w3agile_contact_grid">
     		<div class="col-md-6 w3agile_contact_left">
				...
				<ul class="agileinfo_contact_grid_list">
					<li><i class="fa fa-map-marker contact_icons" aria-hidden="true"></i>74 hope park, Bromley, <span>London.</span></li>
					<li><i class="fa fa-envelope-o contact_icons" aria-hidden="true"></i><a href="mailto:info@example.com">info@smartparking.com</a></li>
					<li><i class="fa fa-phone contact_icons" aria-hidden="true"></i>+44 7878886290</li>
				</ul>
			</div>
	...
	<div class="agileits-w3layouts-map wow zoomIn animated" data-wow-delay=".5s">
		<iframe src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=51.50361379162684,-0.13458251953125003+(London%20Parking)&amp;t=&amp;z=10&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" allowfullscreen></iframe>
	</div><!--https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3023.9503398796587!2d-73.9940307!3d40.719109700000004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25a27e2f24131%3A0x64ffc98d24069f02!2sCANADA!5e0!3m2!1sen!2sin!4v1441710758555-->
	<!--/google map section ends here-->
	<div class="footer-final">
		<div class="copyw3-agile"> 
			<div class="container">
				<p>&copy; 2020 SPOT HERO. All rights reserved | Design by <a href="#">UEL GROUP 9G STUDENTS</a></p>
			</div>
		</div>
	</div>
