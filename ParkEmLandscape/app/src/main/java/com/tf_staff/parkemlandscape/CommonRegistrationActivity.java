        ...
        spinner_for_user_type.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 0) {
                    ...
                    admin_reset = (Button) findViewById(R.id.register_reset_button);
                    admin_reset.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent reset = new Intent(CommonRegistrationActivity.this, CommonRegistrationActivity.class);
                            startActivity(reset);
                        }
                    });
                } else {
